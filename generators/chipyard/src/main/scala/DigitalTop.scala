...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with chipyard.queue.CanHavePeripheryFixedPointQueueBlock
  with chipyard.queue.CanHavePeripheryUIntQueueBlock
  with chipyard.queue.CanHavePeripherySIntQueueBlock
{
