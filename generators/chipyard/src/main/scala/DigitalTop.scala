...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with datarx.CanHavePeripheryDataRX // Enables optionally having an DataRX block
{
...
class DigitalTopModule[+L <: DigitalTop](l: L) extends ChipyardSystemModule(l)
  ...
  with datarx.CanHavePeripheryDataRXModuleImp // Enables optionally having an DataRX block
